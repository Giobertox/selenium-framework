...
public class TopMenu {
	...
	private static final String JOBS_MENU_ITEM = "menu-item-2292";
	
	//Changes- Added "Jobs" menu id and "gotToJobs()" method  
	public static void goToJobs() {
		WebElement jobsMenuItem = Driver.getInstance().findElement(By.id(JOBS_MENU_ITEM));
		jobsMenuItem.click();
	}
