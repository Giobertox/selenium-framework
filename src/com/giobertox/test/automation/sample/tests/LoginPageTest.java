...
public class LoginPageTest extends BasicTestAbstract {
  ...
  public void testWrongPasswordCantLogin() {
    ...
    Assert.assertTrue(LoginPage.hasErrorMessage(),
        "Login error message was expected but not found.");
    Assert.assertEquals(LoginPage.getErrorMessage(), ("Incorrect login."),
        "Error message expected not displayed.");
  }
